...
# Add backend directory to system path so Python can find app modules
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import environmental database configuration and declarative Base metadata
...
# Set base metadata for autogenerate support
