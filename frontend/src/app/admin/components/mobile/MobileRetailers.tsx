            ...
            <form onSubmit={handleSaveRetailerEdit} className="space-y-2.5">
              <div className="space-y-2">
                ...
                <div className="border-t border-slate-100 dark:border-slate-800 pt-2 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <label className="block text-[8px] font-bold text-red-500 uppercase mb-0.5">To Give (₹)</label>
                      <input
                    ...
                    <div>
                      <label className="block text-[8px] font-bold text-emerald-500 uppercase mb-0.5">To Take (₹)</label>
                      <input
                        autoComplete="one-time-code"
                        type="number"
                        inputMode="decimal"
