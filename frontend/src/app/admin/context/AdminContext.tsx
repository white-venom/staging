    ...
    try {
      ...
      const mappedDeps = deps.map((d: any) => {
        ...
        return {
          ...
          from_bank_account_id: d.from_bank_account_id || null,
          fromBankAccountId: d.from_bank_account_id || null,
          ...
          portal_name: d.portal_name || null,
          fromPortalName: d.from_portal_name || null,
          from_portal_name: d.from_portal_name || null,
          fromPortalId: d.from_portal_id || null,
          from_portal_id: d.from_portal_id || null,
      ...
      const mappedPortals = pGroups.map((g: any) => {
        ...
        return {
          ...
          show_in_online_payment: bankAccountsMapped.some((p: any) => p.show_in_online_payment)
        };
      });
