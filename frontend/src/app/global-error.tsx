...
// its own <html>/<body> and stay dependency-free (no store, no providers)
// since whatever those depend on may be exactly what crashed.
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 13, color: "#64748b", lineHeight: 1.5, margin: "0 0 20px" }}>
              CrediiFlow couldn&apos;t start. Your data is safe — try reloading, and contact support if this keeps happening.
            </p>
            <button
              onClick={() => reset()}
              style={{
