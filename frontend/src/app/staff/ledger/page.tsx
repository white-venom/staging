      ...
      <div className="flex-1 w-full max-w-md mx-auto px-2 py-3 flex flex-col gap-2.5 select-none pb-24">
        ...
        <div className="grid grid-cols-3 gap-2 mt-1">
          <div className="bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
            <span className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Cash In</span>
            <span className="text-xs font-black text-emerald-600 dark:text-emerald-500 tracking-tight">
              ₹{totalCollectedSum.toLocaleString("en-IN")}
            </span>
          </div>
          <div className="bg-white dark:bg-slate-900 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
            <span className="text-[7.5px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Cash Out</span>
          ...
          <div className="bg-slate-900 dark:bg-slate-100 p-2.5 rounded-xl border border-slate-800 dark:border-white shadow-md flex flex-col">
            <span className="text-[7.5px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-0.5">Total Cash</span>
            <span className="text-xs font-black text-white dark:text-slate-950 tracking-tight">
                    ...
                    >
                      ...
                      <div className="p-2 flex items-center justify-between">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <div className="min-w-0">
                            <h3 className="text-xs font-black text-slate-800 dark:text-slate-100 tracking-tight truncate">
                              {item.displayName}
                            </h3>
                      ...
                      <div className="grid grid-cols-3 gap-1 bg-slate-100/50 dark:bg-slate-950/40 mx-2 mb-2 p-1 rounded-lg border border-slate-200/30 dark:border-slate-800/40">
                        ...
                        <div className="flex flex-col text-right pr-1">
                          ...
                          <span className="text-[9px] font-black text-slate-800 dark:text-slate-200">₹{snapshots.next.toLocaleString("en-IN")}</span>
                        </div>
                      </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-x-4 gap-y-0.5 text-slate-700 dark:text-slate-350">
                              ...
                              {!den.note_500 && !den.note_200 && !den.note_100 && !den.note_50 && !den.note_20 && !den.note_10 && !den.coins && !den.online_amount && (
                                <div className="text-slate-400 italic text-[9px]">No breakdown provided</div>
                              )}
                            </div>
                          </div>

                          <div className="border-t border-slate-200/40 dark:border-slate-800/40 pt-1.5">
                            <span className="text-[7.5px] uppercase font-black text-slate-400 block mb-0.5">Amount in words:</span>
                          ...
                          {item.remarks && (
                            <div className="border-t border-slate-200/40 dark:border-slate-800/40 pt-1.5 flex items-start gap-1">
                              ...
                              <div>
                                ...
                                <span className="text-slate-750 dark:text-slate-300 font-bold text-[9.5px]">{item.remarks}</span>
                              </div>
                            </div>
                          )}
